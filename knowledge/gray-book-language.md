...
<!-- Source: The-Gray-Book submodule / reference/language -->
...
> [IMAGE: cache-region.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: 07_DocPatch.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: 03_CategoryOutside.PNG] (visual; see https://thegraybook.vvvv.org)
<center>Category patch from the outside</center>

> [IMAGE: 04_CategoryInside.PNG] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: 05_FullCategoryOutside.PNG] (visual; see https://thegraybook.vvvv.org)
<center>Category patch from the outside</center>

> [IMAGE: 06_FullCategoryInside.PNG] (visual; see https://thegraybook.vvvv.org)
<center>Inside a category patch</center>
...
> [IMAGE: 08_ChangePatchType.gif] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: 09_SetCategoryOnDef.gif] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: readonly-package-banner.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: if-region.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: switch-node.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: delegates_delegate.png -- "A Delegate"] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: delegates_delegate_typed.png -- "A Delegate with type assigned"] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: delegates_invoke_variants.png -- "Different variants of the Invoke node"] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: delegates_invoke.png -- "Using the Invoke node"] (visual; see https://thegraybook.vvvv.org)

As delegates are objects, you can for instance store them in a spread and choose which to execute programmatically.

> [IMAGE: delegates_spread.png -- "Delegates stored in a spread"] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: static-enums.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: dynamic-enums.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: node-throwing-error.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: try-region.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: mutable-undefined-order.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: mutable-defined-order.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: writer-reader-undefined.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: writer-reader-defined.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: nodes-without-pins.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: cyclic-graph-error.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: property-instead-of-cyclic-graph.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: frame.png] (visual; see https://thegraybook.vvvv.org)

When selected, the frame can be tinted using one of the predefined colors:
> [IMAGE: frame-selected.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: 02_GroupInside.PNG] (visual; see https://thegraybook.vvvv.org)
<center>Inside a group patch</center>

> [IMAGE: 01_GroupOutside.PNG] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-8e444.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-fb5fa.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-e0989.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-d3c5e.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-6d217.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-4e18c.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: collectioniobox.gif] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: collectioniobox2.gif] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: ioboxes-08b7c.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: nodename.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-Operations-Static-NodeBrowser.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-Utils-StaticOperation-GenericToggle.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-Operations-Static-MyOperation-NodeBrowser.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: PinGroup.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: member-operation-signature.png] (visual; see https://thegraybook.vvvv.org)

*Locked signature of member operation "Update" in the [Patch Explorer](patch-explorer.md)*

> [IMAGE: static-operation-signature.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-DocumentPatch.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-DocumentPatch-BaseCategory.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: vl-DatatypePatch.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: patch-explorer.png] (visual; see https://thegraybook.vvvv.org)

Depending on the type of patch, the explorer shows the relevant information:

## Application Patch Explorer
> [IMAGE: application-patch-explorer.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: definition-patch-explorer.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: datatype-patch-explorer.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: category-patch-explorer.png] (visual; see https://thegraybook.vvvv.org)
...
> [IMAGE: pad-inspector.png] (visual; see https://thegraybook.vvvv.org)
