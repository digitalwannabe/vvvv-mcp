...
$manifestLines = @(
    ...
    ""
    ($ManualFiles | ForEach-Object { "- ``$_``" })
    ""
    "> ``vl-patterns.md`` is built from real help patches (VL.CoreLib, VL.Stride, VL.Skia) and"
    "> tebjan vvvv-skills. Edit it manually when new patterns are discovered."
    ""
    "## Update Procedure"
    ""
    '```powershell'
